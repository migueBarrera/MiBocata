    ...
    public partial class NumericUpDown : ContentView
    {
        public static readonly BindableProperty ValueProperty =
                                                BindableProperty.Create(
                                                    ...
                                                    1.0,
                                                    propertyChanged: (bindable, oldValue, newValue) => ((NumericUpDown)bindable).Value = (double)newValue,
        ...
        public static readonly BindableProperty MaximumProperty =
                                        BindableProperty.Create(
                                                ...
                                                typeof(NumericUpDown),
                                                100.0,
                                                propertyChanged: (bindable, oldValue, newValue) => ((NumericUpDown)bindable).Maximum = (double)newValue);
        ...
        public static readonly BindableProperty StepProperty =
                                                BindableProperty.Create(
                                                        ...
                                                        typeof(NumericUpDown),
                                                        1.0,
                                                        propertyChanged: (bindable, oldValue, newValue) => ((NumericUpDown)bindable).Step = (double)newValue);
